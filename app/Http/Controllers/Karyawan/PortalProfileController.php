...
class PortalProfileController extends Controller
{
    ...
    // New methods for change password flow
    public function showChangePassword()
    {
        return view('karyawan-portal.change-password');
    }
    ...
    public function changePassword(Request $request)
    {
        ...
        return redirect()->route('portal.dashboard')->with('success', 'Password telah diperbarui.');
    }
}
